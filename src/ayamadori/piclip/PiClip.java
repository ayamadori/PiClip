...
//	private long start;
	...
	public static final boolean UPGRADED = true;
...
//		upgraded = true; //storeRepo.isPurchased(productIds[0]);
...
//		}
		try {
			platformRequest("http://apps.opera.com/piclip.html?dm=1&multi=1&redir=1");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
